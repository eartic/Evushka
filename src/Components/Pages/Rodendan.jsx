      ...
      <div className="flex flex-col md:flex-row md:flex-wrap items-center justify-center space-x-0 md:space-x-8 space-y-8 md:space-y-0 mb-8 mt-10">
        {data.rodendani.slice(0, 3).map((item, index) => (
          <div key={index} className="flex flex-col items-center">
            ...
            <div className="shadow-2xl shadow-gray-800 flex items-center justify-center text-center w-96 h-96 rounded-full border-8 border-magenta-500 bg-white">
        ...
        <div className="flex flex-col items-center md:flex-row md:items-start">
          <div className="flex flex-col items-center xl:mt-7 mb-4 md:mb-0">
            ...
            <div className="shadow-2xl shadow-gray-800 flex items-center justify-center text-center w-96 h-96 rounded-full border-8 border-magenta-500 bg-white xl:mr-96 md:ml-12 xl:mt-7">
        ...
        <div className='w-3/4 sm:w-1/2 md:w-1/3 xs:h-5/6 mt-20 p-2'>
          <img src={Madionicar} alt="madionicar" className='w-full h-auto' />
        </div>
        </div>
        </div>
      </div>
